 ...
 *
 * $Id: PassportService.java 1841 2020-09-18 19:11:27Z martijno $
 */
...
public class PassportService extends AbstractMRTDCardService {
     ...
     */
    @Override
    public synchronized PACEResult doPACE(AccessKeySpec keySpec, String oid, AlgorithmParameterSpec params, BigInteger parameterId, boolean resetSsc) throws CardServiceException {
        PACEResult paceResult = (new PACEProtocol(paceSender, wrapper, maxTranceiveLengthForPACEProtocol, maxTranceiveLengthForSecureMessaging, shouldCheckMAC)).doPACE(keySpec, oid, params, parameterId, resetSsc);
