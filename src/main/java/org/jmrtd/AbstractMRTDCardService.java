...
public abstract class AbstractMRTDCardService extends FileSystemCardService {
    ...
    public PACEResult doPACE(AccessKeySpec keySpec, String oid, AlgorithmParameterSpec params) throws CardServiceException {
        return doPACE(keySpec, oid, params, null, false);
    }
     ...
     * @throws CardServiceException if authentication failed or on error
     */
    public abstract PACEResult doPACE(AccessKeySpec keySpec, String oid, AlgorithmParameterSpec params, BigInteger parameterId, boolean resetSsc) throws CardServiceException;
