...
public class SecureMessagingAPDUSender {
    ...
    public ResponseAPDU transmit(APDUWrapper wrapper, CommandAPDU commandAPDU) throws CardServiceException {
        ...
        LOGGER.fine("plain CMD " + Hex.bytesToHexString(plainCapdu.getBytes()));
        if (wrapper != null) {
            commandAPDU = wrapper.wrap(commandAPDU);
            LOGGER.fine("  secured CMD " + Hex.bytesToHexString(commandAPDU.getBytes()));
        }
        ...
        if (wrapper == null) {
            ...
            LOGGER.fine("plain RSP " + Hex.bytesToHexString(responseAPDU.getBytes()));
        } else {
            try {
                ...
                LOGGER.fine("  secured RSP " + Hex.bytesToHexString(responseAPDU.getBytes()));
