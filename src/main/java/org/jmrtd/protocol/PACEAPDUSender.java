...
public class PACEAPDUSender implements APDULevelPACECapable {
    ...
    public synchronized void sendMSESetATMutualAuth(APDUWrapper wrapper, String oid,
        ...
        if (sw != ISO7816.SW_NO_ERROR &&
                sw != (short) ErrorCodes.SW_NON_VOLATILE_MEMORY_CHANGED_COUNTER_5 &&
                sw != (short) ErrorCodes.SW_NON_VOLATILE_MEMORY_CHANGED_COUNTER_4 &&
                sw != (short) ErrorCodes.SW_NON_VOLATILE_MEMORY_CHANGED_COUNTER_3 &&
                sw != (short) ErrorCodes.SW_NON_VOLATILE_MEMORY_CHANGED_COUNTER_2 &&
                sw != (short) ErrorCodes.SW_NON_VOLATILE_MEMORY_CHANGED_COUNTER_1)
        {
