 ...
 *
 * $Id: PACEProtocol.java 1839 2020-08-27 06:28:31Z martijno $
 */
...
public class PACEProtocol {
     ...
     */
    public PACEResult doPACE(AccessKeySpec accessKey, String oid, AlgorithmParameterSpec staticParameters, BigInteger parameterId, boolean resetSsc) throws CardServiceException {
        try {
            return doPACE(accessKey, deriveStaticPACEKey(accessKey, oid), oid, staticParameters, parameterId, resetSsc);
     ...
     */
    private PACEResult doPACE(AccessKeySpec accessKey, SecretKey staticPACEKey, String oid, AlgorithmParameterSpec staticParameters, BigInteger parameterId, boolean resetSsc) throws CardServiceException {
        ...
        try {
            long ssc = 0L;
            if (!resetSsc) {
                ssc = wrapper == null ? 0L : wrapper.getSendSequenceCounter();
            }
    ...
    public PACEIMMappingResult doPACEStep2IM(String agreementAlg, AlgorithmParameterSpec params, byte[] piccNonce, Cipher staticPACECipher) throws PACEException {
        try {
             ...
             */
            /* byte[] step2Response = */
            service.sendGeneralAuthenticate(wrapper, step2Data, maxTranceiveLengthForProtocol, false);
